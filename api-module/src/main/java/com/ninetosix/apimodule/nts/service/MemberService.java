...
import com.ninetosix.apimodule.core.jwt.TokenConfig;
import com.ninetosix.apimodule.core.jwt.TokenProvider;
import com.ninetosix.apimodule.nts.dto.member.*;
import com.ninetosix.coremodule.dto.SignupReqDTO;
import com.ninetosix.coremodule.entity.*;
import com.ninetosix.coremodule.repository.BlacklistRepository;
import com.ninetosix.coremodule.repository.MemberRepository;
import com.ninetosix.coremodule.repository.MemberRoleRepository;
import com.ninetosix.coremodule.repository.RefreshTokenRepository;
...
public class MemberService {
    ...
    public Member findByEmail(String email) {
        return memberRepository.findByEmail(email).orElseThrow(() -> new EntityNotFoundException("Member not found with email: " + email));
    }
